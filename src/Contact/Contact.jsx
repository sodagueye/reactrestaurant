      ...
      <div className="row">
            ...
            <div className="col-12 col-md-6 text-white py-4 px-3" style={{ backgroundColor: "#91725d" }}>
                <div>
                    ...
                    <input type="email" placeholder="Votre Email" className="form-control mt-4 mb-2" /> <br />
                    <textarea name="message" id="messsage" placeholder="Votre message" className="form-control"></textarea>
